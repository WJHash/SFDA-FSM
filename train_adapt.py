...
POWER = 0.9
INPUT_SIZE = (256, 256)
SOURCE_DATA = 'F:/allproj/optic/SFDA-FSM/data/EndoScene'
TRAIN_SOURCE_LIST = 'F:/allproj/optic/SFDA-FSM/dataset/EndoScene_list/train.lst'
TEST_SOURCE_LIST = 'F:/allproj/optic/SFDA-FSM/dataset/EndoScene_list/test.lst'

TARGET_DATA = 'F:/allproj/optic/SFDA-FSM/data/ETIS-Larib'
TRAIN_TARGET_LIST = 'F:/allproj/optic/SFDA-FSM/dataset/ETIS-Larib_list/train.lst'
TEST_TARGET_LIST = 'F:/allproj/optic/SFDA-FSM/dataset/ETIS-Larib_list/test.lst'
...
FOLD = 'fold4'
TARGET_MODE = 'gt'
RESTORE_FROM = 'F:/allproj/optic/SFDA-FSM/checkpoint/Endo_best.pth'
SNAPSHOT_DIR = 'F:/allproj/optic/SFDA-FSM/checkpoint/'
SAVE_RESULT = False
RANDOM_MIRROR = True
IS_ADABN = False
IS_INVERSE = True
...
def main():
    ...
    torch.save(model.state_dict(), 'F:/allproj/optic/SFDA-FSM/output/FSM_last.pth')
